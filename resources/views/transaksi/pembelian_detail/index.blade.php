...
@section('content')
                            ...
                            <div class="form-group row" id="form-diterima">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" id="diterima" class="form-control" autocomplete="off"
                                        name="diterima" value="{{ $pembelian->diterima ?? 0 }}"
    ...
    @include('transaksi.pembelian_detail.produk')
    @include('transaksi.pembelian_detail.pelanggan')
    @include('transaksi.pembelian_detail.form_pelanggan')
@endsection

@include('includes.datatable')

@include('transaksi.pembelian_detail.scripts')
